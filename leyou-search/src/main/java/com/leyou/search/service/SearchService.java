...
public class SearchService {
    ...
    public SearchResult search(SearchRequest request) {
        ...
        //判断是否有搜索条件，如果没有，直接返回null。不预序搜索全部商品
        if(StringUtils.isBlank(request.getKey())){
            System.out.println("searchService为空--------------------------------");
            return null;
        }
        ...
        //添加分页,分页码从0开始
        queryBuilder.withPageable(PageRequest.of(request.getPage()-1, SearchRequest.getDefaultSize()));
        //添加结果集过滤
